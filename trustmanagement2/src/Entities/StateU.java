...
public class StateU implements Entity{
	...
	public StateU()
	{
		...
		principal = new TMSPrincipal("StateU");
		TMSPrincipal p1 = new TMSPrincipal("StateU");
		TMSPrincipal p2 = new TMSPrincipal("RegistrarB");
		RoleName rn = new RoleName("student");
		Role r1 = new Role(p1, rn);
		Role r2 = new Role(p2, rn);
		Credential2 c2 = new Credential2(r1, r2);
		this.addCredential2(c2);
	}
	@Override
