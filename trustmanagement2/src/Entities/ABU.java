...
public class ABU implements Entity{
	...
	public ABU()
	{
		...
		principal = new TMSPrincipal("ABU");
		TMSPrincipal p1 = new TMSPrincipal("ABU");
		TMSPrincipal p2 = new TMSPrincipal("StateU");
		RoleName rn = new RoleName("accredited");
